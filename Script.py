class script(object):
    START_TXT = """I'ᴍ ᴍᴀꜱᴛᴇʀ ᴏʀ ʏᴏᴜ ᴄᴀɴ ᴄᴀʟʟ ᴍᴇ ᴀs EᴠᴀMᴀʀɪᴀ Bᴏᴛ.Iᴛs ᴇᴀsʏ ᴛᴏ ᴜsᴇ ᴍᴇ; ᴊᴜsᴛ ᴀᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴀs ᴀᴅᴍɪɴ, ᴛʜᴀᴛs ᴀʟʟ, ɪ ᴡɪʟʟ ᴘʀᴏᴠɪᴅᴇ ᴍᴏᴠɪᴇs ᴛʜᴇʀᴇ.
...
➥ ᴅᴀᴛᴀʙᴀsᴇ: ᴍᴏɴɢᴏ ᴅʙ
➥ sᴇʀᴠᴇʀ: ʜᴇʀᴏᴋᴜ
➥ ʙᴜɪʟᴅ sᴛᴀᴛᴜs: v1.0.1 [ 𝙱𝙴𝚃𝙰 ]</b>"""
    SOURCE_TXT = """<b>NOTE:</b>
<b>⚠️ᴛʜɪꜱ ʙᴏᴛ ɪꜱ ɴᴏᴛ ᴀɴ  ᴏᴘᴇɴ ꜱᴏᴜʀᴄᴇ ᴘʀᴏᴊᴇᴄᴛ
◆ ꜱᴏᴜʀᴄᴇ ᴄᴏᴅᴇ : കിട്ടിയാൽ എനിക്ക് കൂടെ തന്നേക്ക് 😹
...
◆ Qᴜᴇʀɪᴇꜱ : <a href=https://t.me/AJTGx>ബോസ്സ് 😹</a></b>"""
...
<b>URL buttons:</b>
<code>[Button Text](buttonurl:https://t.me/MASTERAUTOFILTERBOT)</code>
...
• /broadcast - <code>ᴛᴏ ʙʀᴏᴀᴅᴄᴀꜱᴛ ᴀ ᴍᴇꜱꜱᴀɢᴇ ᴛᴏ ᴀʟʟ ᴜꜱᴇʀꜱ</code>"""
    ...
    STATUS_TXT = """<b>📊 ғɪʟᴇs ꜱᴀᴠᴇᴅ: <code>{}</code>
👤 ᴜsᴇʀs: <code>{}</code>
👥 ɢʀᴏᴜᴩꜱ: <code>{}</code>
🉐 ᴏᴄᴄᴜᴘɪᴇᴅ: <code>{}</code>
🆓 ғʀᴇᴇ: <code>{}</code></b>"""
